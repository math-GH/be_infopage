...
array_insert($GLOBALS['BE_MOD']['system'], 100, array(
    'be_infopage' => array(
        'callback' => 'beinfopage',
        'icon' => 'system/modules/be_infopage/assets/info.gif',
        'stylesheet' => 'system/modules/be_infopage/assets/beinfopage.css'
    )
));
